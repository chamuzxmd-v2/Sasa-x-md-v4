...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
  if (!config.SESSION_ID) return console.log('eRICEIJZ#2_vDLpLXbm4zg78BX1xZIBcOW61dTTAyqBVp95WRjW8')
...
conn?.ev?.on('messages.update', async updates => {
  ...
  const udp = botNumber.split('@')[0];
    const tharuzzofc = ('94784167385', '94776932689');
...
if (senderNumber.includes("94784167385") && !isReact && config.OWNER_REACT === 'true') {
    m.react("👤");
}
